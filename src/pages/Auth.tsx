  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message === "Invalid login credentials") {
        errorMessage = "Invalid email or password. If you originally signed up with Google, please use the Google button instead.";
            ...
            >
              {loading ? (
                <>
                  ...
                  {isReset ? "Sending..." : (isLogin ? "Signing in..." : "Creating account...")}
                </>
              ) : (
