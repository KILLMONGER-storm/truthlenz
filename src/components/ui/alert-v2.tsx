...
const alertVariants = cva("relative rounded-lg border", {
    variants: {
        variant: {
            ...
            warning: "border-amber-500/50 text-amber-600 bg-amber-500/5",
            error: "border-red-500/50 text-destructive bg-destructive/5",
            success: "border-emerald-500/50 text-emerald-600 bg-emerald-500/5",
            info: "border-blue-500/50 text-blue-600 bg-blue-500/5",
        },
        size: {
            sm: "px-4 py-3",
            lg: "p-4",
...
>(({ className, ...props }, ref) => (
    <h5 ref={ref} className={cn("text-sm font-semibold mb-1", className)} {...props} />
))
